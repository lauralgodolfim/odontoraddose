	...
	rows: [
		{
			pmmaMm: 20,
			breastEqMm: 21,
			fibroglandularPct: 97,
			gc: [0.336, 0.377, 0.415, 0.45, 0.482, 0.513, 0.539],
		},
		{
			pmmaMm: 30,
			breastEqMm: 32,
			fibroglandularPct: 67,
			gc: [0.245, 0.277, 0.308, 0.338, 0.368, 0.399, 0.427],
		},
		{
			pmmaMm: 40,
			breastEqMm: 45,
			fibroglandularPct: 41,
			gc: [0.191, 0.217, 0.241, 0.268, 0.296, 0.322, 0.351],
		},
		{
			pmmaMm: 45,
			breastEqMm: 53,
			fibroglandularPct: 29,
			gc: [0.172, 0.196, 0.218, 0.242, 0.269, 0.297, 0.321],
		},
		{
			pmmaMm: 50,
			breastEqMm: 60,
			fibroglandularPct: 20,
			gc: [0.157, 0.179, 0.198, 0.221, 0.245, 0.269, 0.296],
		},
		{
			pmmaMm: 60,
			breastEqMm: 75,
			fibroglandularPct: 9,
			gc: [0.133, 0.151, 0.168, 0.187, 0.203, 0.23, 0.253],
		},
		{
			pmmaMm: 70,
			breastEqMm: 90,
			fibroglandularPct: 4,
			gc: [0.112, 0.127, 0.142, 0.157, 0.173, 0.194, 0.215],
		},
		{
			pmmaMm: 80,
			breastEqMm: 103,
			fibroglandularPct: 3,
			gc: [0.097, 0.11, 0.124, 0.136, 0.15, 0.169, 0.188],
		},
	],
} as const;
