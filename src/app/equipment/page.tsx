      ...
      <main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Per-equipment context shared across calculators and reports.
            Saved locally on this device — nothing is sent to a server.
            Rectifier type and dosimeter brand affect calculator formulas;
            the rest is informational and shows up on printed reports.
          </p>
        </header>
