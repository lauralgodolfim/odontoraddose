		...
		<div className="flex flex-col flex-1 bg-zinc-50 font-sans dark:bg-black">
			<main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
				...
				{result ? (
					<section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
						...
						<div className="flex flex-col gap-1 rounded-lg border border-zinc-200 bg-white p-4 text-xs text-zinc-500 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
							...
							<span>
								The IN 56 range is for conventional radiography at the reference
								kVp. Dental intraoral typically reads higher and has no
								published cap; treat the verdict as informational outside the
				...
				<footer className="border-t border-radiation-400/20 pt-4 text-xs text-zinc-400">
					...
					<p className="mt-1">
						The (FDD/100)² term scales the measurement to 1 m. The (kVp ratio)²
						term normalises to a reference kVp using the standard tube-output
						kVp² scaling.
					</p>
				</footer>
			</main>
