			...
			<main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
				<header className="flex flex-col gap-2">
					...
					<p className="text-sm text-zinc-600 dark:text-zinc-400">
						Mean glandular dose for a standard-equivalent breast. Looks up g·c
						(AIEA HHS 17) by PMMA thickness and HVL, then the S factor for the
						target/filter combination, and multiplies by the entrance air kerma.
						Validated against the IN 54 tolerance for that PMMA thickness.
					</p>
					<div className="pt-1">
						<EquipmentBadge />
					</div>
				...
				<footer className="border-t border-radiation-400/20 pt-4 text-xs text-zinc-400">
					...
					<p className="mt-1">
						g·c lookup: AIEA HHS 17 (pg. 114). S factors: AIEA HHS 17 Table on
						target–filter combinations and W/Al variant by PMMA. IN 54 tolerance
						is a strict upper bound on MGD per PMMA thickness.
					</p>
				</footer>
			</main>
		</div>
