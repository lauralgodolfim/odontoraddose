			...
			<main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
				<header className="flex flex-col gap-2">
					...
					<p className="text-sm text-zinc-600 dark:text-zinc-400">
						Weighted CTDI from central + peripheral chamber readings, scaled to
						CTDIvol by pitch and length-corrected for short scans, then DLP and
						effective dose. Compares against the machine-displayed CTDIvol per
						IN 55.
					</p>
					<div className="pt-1">
						<EquipmentBadge />
				...
				{result ? (
					...
					<section className="rounded-lg border border-dashed border-zinc-300 bg-white/40 p-6 text-sm text-zinc-500 dark:border-zinc-700 dark:bg-zinc-950/40">
						Enter the five chamber readings (central + 3 h, 6 h, 9 h, 12 h) to
						see the dose calculation.
					</section>
				)}
