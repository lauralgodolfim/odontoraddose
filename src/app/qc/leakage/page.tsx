			...
			<main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
				<header className="flex flex-col gap-2">
					...
					<p className="text-sm text-zinc-600 dark:text-zinc-400">
						...
						under maximum-load conditions (max kVp + max continuous mA). Limit:
						1 mGy/h per IN 56 / IEC 60601-1-3.
					</p>
					<div className="pt-1">
						<EquipmentBadge />
					</div>
				...
				<footer className="border-t border-radiation-400/20 pt-4 text-xs text-zinc-400">
					...
					<p className="mt-1">
						The (distance/100)² term scales the measurement to 1 m via inverse
						square. Test must be performed at the maximum continuous tube load
