...
export const conventionalExams: ConventionalExam[] = [
  { slug: "lumbar-ap", label: "Lumbar spine AP", thicknessCm: 23, maxEsdMgy: 10 },
  { slug: "lumbar-lat", label: "Lumbar spine LAT", thicknessCm: 30, maxEsdMgy: 30 },
  { slug: "lumbar-lsj", label: "Lumbar spine LSJ", thicknessCm: 20, maxEsdMgy: 40 },
  { slug: "abdomen-ap", label: "Abdomen AP", thicknessCm: 23, maxEsdMgy: 10 },
  { slug: "urography-ap", label: "Urography AP", thicknessCm: 23, maxEsdMgy: 10 },
  { slug: "cholecystography-ap", label: "Cholecystography AP", thicknessCm: 23, maxEsdMgy: 10 },
  ...
  { slug: "thoracic-ap", label: "Thoracic spine AP", thicknessCm: 23, maxEsdMgy: 7 },
  { slug: "thoracic-lat", label: "Thoracic spine LAT", thicknessCm: 32, maxEsdMgy: 20 },
