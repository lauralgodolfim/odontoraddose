			...
			<main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
				<header className="flex flex-col gap-2">
					...
					<p className="text-sm text-zinc-600 dark:text-zinc-400">
						Light box luminance and uniformity, diagnostic monitor luminance and
						contrast ratio, and reading-room ambient illuminance, against AAPM
						TG-18 references.
					</p>
					<div className="pt-1">
						<EquipmentBadge />
				...
				<footer className="border-t border-radiation-400/20 pt-4 text-xs text-zinc-400">
					...
					<p className="mt-1">
						References: AAPM TG-18, DICOM PS 3.14 GSDF. Light box minimum mean
						luminance 1500 cd/m²; uniformity ≤ 30%. Diagnostic monitor L max ≥
						350 cd/m²; L max/L min ≥ 250. Ambient ≤ 50 lux.
					</p>
				</footer>
			</main>
		</div>
