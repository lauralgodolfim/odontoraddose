      ...
      <main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            ...
            visible fibres, masses, and speck groups against the ACR
        ...
        {result ? (
          <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {(Object.keys(ACR_THRESHOLDS) as (keyof typeof ACR_THRESHOLDS)[]).map(
              (k) => {
        ...
        <footer className="border-t border-radiation-400/20 pt-4 text-xs text-zinc-400">
          <p>
            ...
            object first; if a smaller object in the same group is more
            visible than a larger one, count both.
          </p>
        </footer>
      </main>
    </div>
