			...
			<main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 sm:px-8">
				<header className="flex flex-col gap-2">
					...
					<p className="text-sm text-zinc-600 dark:text-zinc-400">
						Entrance skin dose for conventional radiography. The chamber reading
						is corrected by the radiation-quality factor and scaled to the
						patient&apos;s skin via inverse square, then compared to the IN
						90/2021 Annex II reference dose for that exam.
					</p>
					<div className="pt-1">
						<EquipmentBadge />
					</div>
				...
				{result ? (
					...
					<section className="rounded-lg border border-dashed border-zinc-300 bg-white/40 p-6 text-sm text-zinc-500 dark:border-zinc-700 dark:bg-zinc-950/40">
						Enter chamber dose, focus–detector and FID distances, and the table-
						or wall-stand-to-receptor offset for the chosen station.
					</section>
				)}
